...
setup(name='piclemx_pulumi_opensearch',
      python_requires='>=3.7',
      version=VERSION,
      description="A Pulumi package for creating and managing Opensearch resources",
      long_description=readme(),
      long_description_content_type='text/markdown',
      keywords='pulumi opensearch category/database',
      url='https://github.com/piclemx/pulumi-opensearch',
      project_urls={
