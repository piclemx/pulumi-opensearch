...
SHELL            := /bin/bash
PROJECT          := github.com/piclemx/pulumi-opensearch
NODE_MODULE_NAME := @piclemx/pulumi-opensearch
TF_NAME          := opensearch
...
TFGEN            := pulumi-tfgen-opensearch
PROVIDER         := pulumi-resource-opensearch
...
upstream/.git:
	...
	git -c advice.detachedHead=false clone --depth 1 --branch 'v$(PROVIDER_VERSION)' 'https://github.com/opensearch-project/terraform-provider-opensearch' upstream
